...
(function($) {
  ...
  $.fn.raptorize = function(options) {
    ...
    return this.each(function() {
		...
		var raptorImageMarkup = '<img id="elRaptor" style="display: none" src="assets/imagenes/raptor.png" />'
		var raptorAudioMarkup = '<audio id="elRaptorShriek" preload="auto"><source src="assets/media/raptor-sound.mp3" /><source src="assets/media/raptor-sound.ogg" /></audio>';
		var locked = false;
